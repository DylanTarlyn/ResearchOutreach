...
research_tag = db.Table('post_tag',
...
class Post(db.Model):
    ...
    research_field = db.relationship('Fields', secondary = research_tag, primaryjoin=(research_tag.c.post_id == id), backref = de.backref('post_tag', laxy='dynamic'), lazy ='dynamic')
